...
interface EditCommunityModalProps {
    community: Course;
    onSave: (updatedData: Partial<Course>) => void;
    onClose: () => void;
}

const EditCommunityModal: React.FC<EditCommunityModalProps> = ({ community, onSave, onClose }) => {
        ...
        >
            ...
            >
                <GlassCard className="relative">
                    ...
                    <h2 className="text-2xl font-bold mb-6 text-[var(--text-primary)]">Edit Community</h2>
